...
# вариант решения задачи со списком.

my_num = [input("Введите цифру для поиска: "), input("Введите количество чисел: "), 0]
...
print(f'Цифра {my_num[0]} в введённых числах встречается {my_num[2]} раз(а).')

# Проверяем размеры переменных

print(f'Размер занятой под переменные памяти равен {check_size(my_num) + check_size(j) + check_size(i)} байт.')
...
# Размер занятой под переменные памяти равен 158 байт.
